...
# GitHub repo link config - set to false or 0 to hide
SHOW_GITHUB = os.environ.get('SHOW_GITHUB', 'true').lower() not in ('false', '0', 'off', 'no')
GITHUB_URL = os.environ.get('GITHUB_URL', 'https://github.com/Garenzhou/domain-sale-page')
...
<body>
    ...
    {% if show_github %}
    <a href="{{ github_url }}" class="github-link" target="_blank" rel="noopener noreferrer" aria-label="View on GitHub">
